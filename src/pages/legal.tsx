...
const Legal: NextPage = () => (
  <main className="legal">
    ...
    <p className="text-justify">
      ...
      par un outil libre intitulé <a href="">Matomo</a> spécifiquement
      paramétré, respectant les conditions d&apos;exemption du consentement de
      l&apos;internaute définies par la{" "}
      <a href="">recommandation « Cookies »</a> de la Commission nationale
      informatique et libertés (CNIL). Cela signifie, notamment, que ces cookies
      ne servent qu&apos;à la production de statistiques anonymes et ne
      permettent pas de suivre la navigation de l&apos;internaute sur
      d&apos;autres sites.
    </p>
  </main>
)
